from gems import parse_skills_in_item
from stats import Stats, _parse_item
from gems import GemQualityType
...
def test_global_mods_from_item():
	char_stats = Stats()
	item = create_item(
		mods=[
